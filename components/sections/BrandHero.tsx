    ...
    <section
      ...
      style={isSea ? {
        background: `
          ...
          radial-gradient(circle at 85% 85%, rgba(86,165,214,0.10) 0%, transparent 45%),
          #1A1A1A
        `,
      } : { backgroundColor: '#DA6629' }}
    >
            ...
            {brand.image ? (
              ...
              <>
                ...
                <span
                  ...
                  style={{ fontSize: "clamp(48px, 6vw, 80px)", textShadow: "0 4px 20px rgba(0,0,0,0.3)" }}
                >
                  {brand.name}
                </span>
                <span
